Pod::Spec.new do |s|
  ...
  s.platform     = :ios, '6.0'
  s.source       = { :git => "https://github.com/jibjab/storybots-libraries.git", :tag => "0.4.2" }
  s.requires_arc = true
  ...
  s.subspec 'HomeScreen' do |ss|
    ...
    ss.resources = "HomeScreen/SBHomeScreen/Resources/*.{png,xib,plist,bundle}"
    ss.dependency 'SBLibraries/Utilities'
    ss.dependency 'SBLibraries/CommonAssets'
    ss.dependency 'SBLibraries/AccountAuthentication'
    ss.dependency 'SBLibraries/Popups'
  ...
  s.subspec 'UniversalSettings' do |ss|
    ...
    ss.resources = "UniversalSettings/SBSettings/Resources/*.{png,xib,strings}"
    ss.dependency 'SBLibraries/Utilities'
    ss.dependency 'SBLibraries/CommonAssets'
    ss.dependency 'SBLibraries/AccountAuthentication'
    ss.dependency 'SBLibraries/AccountCharacters'
